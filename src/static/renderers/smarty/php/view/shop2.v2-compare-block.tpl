{if $shop2.json.compare}
	...
	{if $compared}
		<div class="compare-block">
			...
			<a href="{get_seo_url mode="compare" prefix=$shop2.uri}" class="shop2-btn" target="_blank">{#SHOP2_COMPARE#}</a>
			<a href="#" class="compare-block-clear">{#SHOP2_CLEAR#}</a>
			<a href="#" class="compare-block-toggle">{#SHOP2_COMPARISON_LIST#} (<span>{$compared}</span>)</a>
		</div>
	{/if}
