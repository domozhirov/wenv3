	...
	<tr>
		<td class="cart-product">
			...
			<div class="cart-product-details">
				...
				<div class="cart-product-name"><a {if $product.alias != "#"}href="{get_seo_url mode="product" alias=$product.alias}"{/if}>{$product.name}</a></div>
				...
				{else}
					{if $fix_discount}
						{if $e.custom_params[co].amount}
							{$e.custom_params[co].total|price_convert}
						{else}
